...
!["Primeira modelagem no Excel"](modeloconceitual-excel.png)

#### Modelo conceitual no Excel - 1ª Normalização

!["Primeira modelagem no Excel - 1ª Normalização"](modeloconceitual-excel%201-normalizacao.png)

#### Modelo conceitual no Excel - 2ª Normalização

!["Primeira modelagem no Excel - 2ª Normalização"](modeloconceitual-excel%202-normalizacao.png)

### Modelagem de Dados com o diagrama de entidade relacional
#### Neste diagrama temos as cardenalidades
    - Um para Muitos
    - Um para Um
!["Segunda modelagem"](modelo-conceitual-paperbook.png)
